...
public class FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("OpcUaClientMx.Certificate", mendixObject.getType())) {
			return opcuaclientmx.proxies.Certificate.initialize(context, mendixObject);
		}
